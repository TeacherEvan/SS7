...
def test_emoji_spawning():
    ...
    level = AlphabetLevel(
        width, height, screen, 
        fonts['fonts'], fonts['small_font'], fonts['target_font'],
        None, None, None, None, None, None, None,  # Mock managers
        resource_manager, None, None, None, None,  # Mock functions
        [], [], None, None, None  # Mock lists and functions
    )
