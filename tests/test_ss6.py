...
class TestObjectPooling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from utils.object_pooling import Explosion, ObjectPool, Particle, PoolManager
...
class TestAnimationSystem(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test environment."""
        from utils.animation_system import AnimatedTarget, Animation, AnimationManager, EaseType
    ...
    def test_animation_creation(self):
        ...
        animation = self.Animation(self.test_obj, "x", 0.0, 100.0, 1.0, self.EaseType.LINEAR)
    ...
    def test_animation_manager(self):
        ...
        # Create animation
        animation = manager.create_target_animation(target, "scale", 2.0, 1.0, self.EaseType.LINEAR)
...
class TestGameLogic(unittest.TestCase):
    ...
    def test_sequence_progression(self):
        ...
        from settings import GROUP_SIZE, SEQUENCES
        ...
        # Test grouping
        groups = [
            alphabet_sequence[i : i + GROUP_SIZE]
            for i in range(0, len(alphabet_sequence), GROUP_SIZE)
        ]
