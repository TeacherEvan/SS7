...
class VoiceAssignmentSystem:
    ...
    def get_voice_for_content(
        self, level_type: LevelType, content_type: ContentType, content: str = "", context: str = ""
    ) -> Tuple[str, Dict]:
        """
        ...
        if content_type == ContentType.EMOJI and level_type in [
            LevelType.ALPHABET,
            LevelType.CL_CASE,
        ]:
        ...
        if (
            level_type in [LevelType.COLORS, LevelType.SHAPES]
            and content_type == ContentType.TARGET_HIT
        ):
    ...
    def _get_percentage_based_voice(self, level_type: LevelType) -> Tuple[str, Dict]:
        ...
        if not level_rules:
            ...
            level_rules = {"male_elderly_stoic": 40, "female_default": 60}
