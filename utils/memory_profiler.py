...
class MemoryProfiler:
    ...
    def update(self, dt: float, additional_data: Dict[str, Any] = None):
        ...
        metrics.memory_peak = self.process.memory_info().peak_wss / 1024 / 1024 if hasattr(self.process.memory_info(), 'peak_wss') else metrics.memory_usage
    ...
    def get_average_metrics(self, samples: int = 60) -> Dict[str, float]:
        ...
        return {
            ...
            'avg_texture_memory': sum(m.texture_memory for m in recent_metrics) / len(recent_metrics),
        }
    ...
    def draw_overlay(self, screen: pygame.Surface, font: pygame.font.Font, 
                    x: int = 10, y: int = 10):
        """
