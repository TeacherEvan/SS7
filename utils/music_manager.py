...
class BackgroundMusicManager:
    ...
    def __init__(self, music_dir: str = None):
        ...
        """
        self.music_dir = music_dir or os.path.join(os.path.dirname(os.path.dirname(__file__)), "music")
        self.config_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "config", "music_config.json")
    ...
    def _load_config(self) -> Dict:
        ...
        default_config = {
            ...
            "themes": {
                ...
                "numbers": {
                    "tracks": ["counting_fun.mp3", "number_dance.mp3"],
                    "volume": 0.25
                },
                "colors": {
                    "tracks": ["rainbow_melody.mp3", "color_symphony.mp3"],
                    "volume": 0.25
                },
                "shapes": {
                ...
                "menu": {
                    "tracks": ["welcome_theme.mp3", "menu_ambient.mp3"],
                    "volume": 0.2
                },
                "victory": {
                    "tracks": ["celebration.mp3", "success_fanfare.mp3"],
                    "volume": 0.4
                }
            }
        }
    ...
    def _scan_music_library(self) -> Dict[MusicTheme, List[str]]:
        ...
        for filename in os.listdir(self.music_dir):
            if any(filename.lower().endswith(ext) for ext in music_extensions):
                ...
                elif any(word in filename_lower for word in ['shape', 'geometry', 'circle', 'square']):
                ...
                elif any(word in filename_lower for word in ['victory', 'win', 'success', 'celebrate']):
